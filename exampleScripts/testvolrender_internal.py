...
# format the data following: http://pythology.blogspot.com/2014/08/you-can-do-cool-stuff-with-manual.html
...
# now, we'll make a "fake" bvox file
#from yt.extern.six.moves import StringIO # because we need something that works in py3 & 2
...
hp = np.array([header,pointdata])
#outfile = StringIO()
from io import BytesIO
outfile = BytesIO(hp)
#outfile.write(header.tostring())# + pointdata.tostring())
...
tex.voxel_data.domain_object = bpy.data.objects['Cube']
